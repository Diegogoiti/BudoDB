...
#[component]
pub fn Form(nombre: Signal<String>, fecha_nac: Signal<String>, rango: Signal<u32>, representante: Signal<String>, contacto: Signal<String>, rallita: Signal<bool>) -> Element {
